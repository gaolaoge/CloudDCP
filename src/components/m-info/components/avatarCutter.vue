<template>
  <section class="c-avatar-cutter" @dragstart="false">
    ...
    <div class="dialog-header">
      ...
      <img src="@/icons/shutDialogIcon.png" class="closeBtn" @click="onCancel">
    </div>
    <div class="dialog-body">
      ...
      <div class="dialog-btn-group">
        <div class="dialog-btn cancel" @click="onCancel"><span>取消</span></div>
        <div class="dialog-btn save" @click="onEnter"><span>确定</span></div>
      </div>
    </div>
  </section>
</template>

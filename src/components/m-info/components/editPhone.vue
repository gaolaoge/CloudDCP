    ...
    <div class="dialog-body">
      ...
      <div class="choosePhone" v-show="step == 'choosePhone'">
        ...
        <div class="x dialog-btn-group">
          <div class="dialog-btn cancel" @click="phoneVerifToNav('chooseVerificationMethod')">
            <span>{{ btnCancel }}</span>
          </div>
          <div
            :class="[{'cannotBe': !newPhoneVeri.phoneCodeError || !newPhoneVeri.phoneError || !phoneVeri.oldPhoneCodeError}, 'dialog-btn','save']"
      ...
      <div class="chooseEmail" v-show="step == 'chooseEmail'">
        ...
        <div class="x dialog-btn-group">
          ...
          <div
            :class="[{'cannotBe': !emailVeri.emailCodeError || !emailVeri.newPhoneError || !emailPhoneVeri.phoneCodeError}, 'dialog-btn','save']"
      ...
      <div class="choosePassword" v-show="step == 'choosePassword'">
        ...
        <div class="x dialog-btn-group">
          ...
          <div
            :class="[{'cannotBe': !passwordVeri.passWordError || !passwordVeri.newPhoneError || !passwordVeri.newPhoneCodeError}, 'dialog-btn','save']"

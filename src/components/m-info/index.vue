<template>
  <div class="info-wrapper">
    ...
    <el-dialog
      ...
      :show-close="false"
      width="574px">
      <avatar-cutter @cancel="showCutter = false"
                     return-type="url"
                     @enter="uploadAvatar"
                     ref="avatarEdit"/>
    </el-dialog>
    ...
    <el-dialog
      ...
      :show-close="false"
      width="638px">
      <edit-phone @cancel="editPhoneMoudle = false"/>
    </el-dialog>
    <!--修改邮箱-->
    <el-dialog
      ...
      :show-close="false"
      width="400px">
      <edit-email @cancel="editEmailMoudle = false"/>
    </el-dialog>
    <!--修改密码-->
    <el-dialog
      ...
      :show-close="false"
      width="400px">
      <edit-password @cancel="editPasswordMoudle = false"/>
    </el-dialog>
    <!--修改昵称-->
    <el-dialog
      ...
      :show-close="false"
      width="574px">
      <edit-name @cancel="editNameMoudle = false"/>
    </el-dialog>
  </div>
</template>
